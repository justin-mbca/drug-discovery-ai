...
flowchart TD
    ...
    B --> C[Sample Latent Space with Property Condition]
    C --> D[Generate Molecules with Desired Properties]
```
...
```{mermaid}
flowchart LR
    A[Train Model on (SMILES, Properties)] --> B[Specify Target Property]
